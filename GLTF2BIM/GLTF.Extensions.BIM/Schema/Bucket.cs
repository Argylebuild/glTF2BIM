...
namespace GLTF2BIM.GLTF.Extensions.BIM.Schema
{
	public abstract class Bucket
	{
		...
		/// <summary>
		/// Link colors are generated by a random color generator seeded by the gltf file's name.
		/// Colors are stored in LinkColorDictionary so that they can be reused.
		/// </summary>
		/// <param name="name"></param>
		/// <returns></returns>
		private Vector3 GetColorByGltfName(string name)
		{
			var r = StringToRandomFloat(name + "r");
			var g = StringToRandomFloat(name + "g");
			var b = 1 - (r + g);
